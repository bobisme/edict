...
**Important**: Creating a review with `--reviewers` assigns the reviewer in seal (metadata), but does NOT spawn them. You still need an @mention in a bus message to trigger the spawn hook.
